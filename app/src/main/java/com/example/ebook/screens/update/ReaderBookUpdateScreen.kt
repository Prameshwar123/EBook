package com.example.ebook.screens.update
...
import com.example.ebook.components.InputField
import com.example.ebook.components.RatingBar
import com.example.ebook.components.ReaderAppBar
import com.example.ebook.components.RoundedButton
import com.example.ebook.components.showToast
import com.example.ebook.data.DataOrException
...
import com.example.ebook.utils.formatDate
        ...
        Surface(
            ...
            Column(
                ...
                if (bookInfo.loading == true) {
                    ...
                    }?.let { book -> ShowSimpleForm(book = book, navController) }
                }
            }
        }
    }
        ...
        if (bookInfo.data != null) {
            Column(modifier = Modifier.padding(4.dp),
                ...
                bookInfo.data!!.firstOrNull{mBook ->
                    mBook.googleBookId == bookItemId
                }?.let { CardListItem(book = it, onPressDetails = {}) }
            }
        }
